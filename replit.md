...
-   **Mentoring System**: Manages 1:1 mentoring sessions, including session lifecycle, debrief logging with AI analysis, co-mentor support, and configurable onboarding questions.
-   **Journey Framework**: Tracks culturally-grounded Māori stage progression (kākano → tipu → ora) and venture types.
