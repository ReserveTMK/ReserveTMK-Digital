...
-   **Scheduling System**: Manages mentor/staff availability with Google Calendar sync and a public booking page for pathway-driven mentee scheduling. Public booking flow: new mentees see only Discovery Session (60 min); returning mentees see Quick Session (30 min) and Standard Session (60 min). Confirmation screen shows location/directions from org profile. Calendar events include location + directions in description and send invites to mentees.
