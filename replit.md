...
-   **Community Member Management**: Automates classification of community members based on engagement signals, with AI relationship scoring. People page has three views: Our Community, Our Innovators, and All Contacts.
-   **Our Innovators**: A curated subset of contacts marked with `isInnovator` flag. Quick-promote from Community view via dropdown menu; bulk add/remove in edit mode. Shown as amber lightbulb badge on contact cards.
