...
const XERO_SCOPES = "openid profile email accounting.contacts accounting.contacts.read accounting.invoices accounting.invoices.read accounting.transactions.read offline_access";
