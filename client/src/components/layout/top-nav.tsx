...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      { name: "Contacts", href: "/community/people", icon: Users, description: "Manage contacts & mentees" },
      { name: "Organisations", href: "/community/groups", icon: Network, description: "Organisations & collectives" },
    ],
  },
  {
    name: "Delivery",
