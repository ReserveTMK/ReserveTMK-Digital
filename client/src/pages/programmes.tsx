...
import { PROGRAMME_CLASSIFICATIONS, PROGRAMME_STATUSES, type Programme } from "@shared/schema";
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground flex-wrap">
                        {programme.startDate && (
                          <span className="flex items-center gap-1">
                            ...
                            {format(new Date(programme.startDate), "d MMM yyyy")}
                            {programme.endDate && ` - ${format(new Date(programme.endDate), "d MMM yyyy")}`}
                          </span>
                        )}
                        {programme.location && (
                          <span className="flex items-center gap-1">
