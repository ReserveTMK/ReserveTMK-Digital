...
export default function CasualHirePage() {
  ...
  // Returning-booker studio questions
                      ...
                      <div className="space-y-3 border border-border rounded-lg p-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <Textarea
                            ...
                            data-testid="input-studio-produce"
                          />
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              data-testid="button-studio-used-before-yes"
                            >Yes</button>
                            <button
                              type="button"
                              ...
                              data-testid="button-studio-used-before-no"
                            >No</button>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              data-testid="button-studio-needs-help-yes"
                            >Yes</button>
                            <button
                              type="button"
                              ...
                              data-testid="button-studio-needs-help-no"
                            >No</button>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <Textarea
                            ...
                            data-testid="input-studio-other"
                          />
                        </div>
                      ...
                      <div className="space-y-3 border border-border rounded-lg p-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <Textarea
                            ...
                            data-testid="input-studio-recording"
                          />
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              data-testid="button-studio-changes-yes"
                            >Yes</button>
                            <button
                              type="button"
                              ...
                              data-testid="button-studio-changes-no"
                            >No</button>
                          </div>
                          {studioSetupChanges === true && (
                            <Textarea
                              ...
                              className="mt-1"
                              data-testid="input-studio-setup-details"
                            />
                          )}
                        </div>
