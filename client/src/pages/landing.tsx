  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-[hsl(var(--brand-orange))]/5 rounded-full blur-3xl opacity-60" />
      </div>

      <nav className="relative z-10 container mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="bg-[hsl(var(--brand-orange))] w-10 h-10 rounded-xl flex items-center justify-center">
            <span className="text-white font-display font-bold text-lg">R</span>
          </div>
          <span className="font-display font-bold text-xl">Reserve<span className="text-primary">TMK</span></span>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary text-sm font-medium text-secondary-foreground mb-4 border border-border">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[hsl(var(--brand-orange))] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[hsl(var(--brand-orange))]"></span>
            </span>
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold text-foreground leading-[1.1]">
            Track Growth, <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-[hsl(var(--brand-orange))] to-[hsl(var(--brand-pink))]">
              Measure Impact.
            </span>
          </h1>
        ...
        <div className="mt-32 grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-card/50 backdrop-blur-sm border border-white/20 p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 bg-gradient-to-br from-primary/10 to-[hsl(var(--brand-orange))]/10 rounded-2xl flex items-center justify-center mb-6">
